...
class Manufacturer extends Component {
    ...
    state = { storageValue: 0, web3: null, accounts: null, contract: null, modalShow: false, setModalShow: false };
    /**constructor(props) {
      super(props);
      this.state = {
        modalShow: false,
...
<Button id = "addCarButton" onClick = {() => this.setState({ modalShow: true })}>Add Car 
</Button> </div> </div> <MyVerticallyCenteredModal show = { this.state.modalShow } onHide = {() => this.setState({ modalShow: false })}/> 
...
function Home() {
    ...
    return ( 
        ...
        <h1 >Welcome to < h1 id = "decentralease" > DecentraLease </h1> </h1 > 
        </div> 
...
function MyVerticallyCenteredModal(props) {
    ...
    >
        ...
        Modal heading </Modal.Title> </Modal.Header > 
        <Modal.Body >
        <AddForm / >
        </Modal.Body>
